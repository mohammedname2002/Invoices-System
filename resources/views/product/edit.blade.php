                    ...
                    <form action="{{ route('product.update', $product->id) }}" method="POST" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="product_name" class="form-control" id="product_name" placeholder="Product Name" value="{{ $product->name }}">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="date" id="date" name="date_of_create" value="{{ old('date_of_create', date('Y-m-d', strtotime($product->date_of_create))) }}" >
